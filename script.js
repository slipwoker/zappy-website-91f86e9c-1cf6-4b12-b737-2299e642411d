    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('required')) {
        const isEmpty = field.type === 'checkbox' || field.type === 'radio'
          ? !field.checked
          : !validators.required(String(value));
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '91f86e9c-1cf6-4b12-b737-2299e642411d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '91f86e9c-1cf6-4b12-b737-2299e642411d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '91f86e9c-1cf6-4b12-b737-2299e642411d';
